...
(userNetIncome >= 2 * userBills && userSavings === "yes") ? console.log("Wise choice because you make $" + madeInSavings + " per month and " + yearlyInterest + " per year in your savings account.") : console.log("You're missing out on a free $" + madeInSavings + " per month, just for having a savings account and putting " + percentToSavings + "% in every month. That's " + yearlyInterest + " per year.");
//If your savings account will make you more than 25 dollars per month
if(madeInSavings > 25){
    console.log("You should definitely have a savings account. That's an extra $" + madeInSavings + " per month and $" + yearlyInterest + " per year");
}
//If your savings account will make more than 5 dollars per month
else if(madeInSavings > 5){
    console.log("Having a savings account can't hurt you. It's an extra $" + madeInSavings + " per month. and $" + yearlyInterest + " per year.");
}
//If your savings account will make less than 5 dollars per month
else{
    console.log("You don't really need a savings account, it's only an extra $" + madeInSavings + " per month or $" + yearlyInterest + "per year, but if you have or start one then more power to you.");
}
